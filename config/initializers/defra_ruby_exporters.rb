module DefraRuby
  module Exporters
    ...
    EPR_EXPORT_AWS_CREDENTIALS = Aws::Credentials.new(
      (ENV["AWS_DAILY_EXPORT_ACCESS_KEY_ID"] || raise("Environment variable AWS_MANUAL_EXPORT_ACCESS_KEY_ID has not been set")),
      (ENV["AWS_DAILY_EXPORT_SECRET_ACCESS_KEY"] || raise("Environment variable AWS_MANUAL_EXPORT_SECRET_ACCESS_KEY has not been set"))
    )
