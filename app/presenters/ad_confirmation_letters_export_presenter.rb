...
class AdConfirmationLettersExportPresenter < BasePresenter
  ...
  def letters_label
    if number_of_letters.positive?
      pluralize(number_of_letters, I18n.t("ad_confirmation_letters_exports.index.table.letters_label"))
    else
      I18n.t("ad_confirmation_letters_exports.index.labels.no_registrations")
    end
  end
  ...
  def printed_label
    I18n.t(
      "ad_confirmation_letters_exports.index.labels.printed",
  ...
  def none_to_print_label
    I18n.t("ad_confirmation_letters_exports.index.labels.none_to_print")
  end
end
